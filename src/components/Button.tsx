...
const styles = {
  ...
  primary:
    "relative overflow-hidden bg-coral text-white shadow-glow hover:-translate-y-0.5 hover:shadow-[0_18px_45px_rgba(228,87,78,0.28)] hover:bg-[#d14a42] before:absolute before:inset-y-0 before:-left-10 before:w-8 before:rotate-12 before:bg-white/30 before:transition-all before:duration-500 hover:before:left-[120%]",
  secondary:
